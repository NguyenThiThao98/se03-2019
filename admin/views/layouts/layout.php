            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="?c=home&m=index"><i class="fa fa-home"></i> Trang chủ </a>
                  ...
                  <li><a href="?c=order&m=index"><i class=" fa fa-ticket"></i>Đơn hàng</a>
                    
                  </li>

                  <li><a href="?c=customer&m=index"><i class=" fa fa-user"></i>Khách hàng</a>
                    
                  </li>

                  <li><a><i class="fa fa-database"></i> Sản phẩm <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="?c=brand&m=index">Thương hiệu</a></li>
                      <li><a href="?c=productCategory&m=index">Danh mục</a></li>
                      <li><a href="?c=product&m=index">Sản phẩm</a></li>
                      <li><a href="?c=coupon&m=index">Mã khuyến mại </a></li>
                      <li><a href="glyphicons.html">Đánh giá</a></li>
                      
                    </ul>
                  </li>
                  <li><a href="?c=banner&m=index"><i class=" fa fa-tag"></i>Quảng cáo</a>
                    
                  </li>
                  
                  <li><a><i class="fa fa-clone"></i>Trang tĩnh <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="fixed_sidebar.html">Fixed Sidebar</a></li>
                      <li><a href="fixed_footer.html">Fixed Footer</a></li>
                    </ul>
                  </li>
                  <li><a href="?c=admin&m=index"><i class=" fa fa-male"></i>Admin</a>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="pblic/images/img.jpg" alt="">John Doe
