...
<div class="right_col" role="main">
  <div class="">
    ...
    <div class="title_right" style="float: right;">
        ...
        <a href="index.php?c=brand&m=create" style="color: #BA5905;">THÊM MỚI</a>
    </div>
</div>
</div>
        ...
        if (count($brands) > 0) : 
            ...
            foreach ($brands as $item) :
                ...
                <tr>
                    ...
                    <td><img src="<?php echo $item['logo'];?>" style="width: auto;height: 200px;"></td>
                    <td><img src="<?php echo $item['image'];?>" style="width: auto;height: 200px;"></td>
                    <td>
