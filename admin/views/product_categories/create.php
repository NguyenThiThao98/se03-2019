    ...
    <div class="x_panel">
      <div class="x_content">
        ...
        <form class="form-horizontal form-label-left" novalidate action="" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Thư mục cha <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <select name="parent_id" rows="6" class="form-control col-md-7 col-xs-12">
                ...
                <option value="0" 
                  <?php if (isset($_POST['parent_id']) && $_POST['parent_id'] == 0) echo 'selected = "selected" ' ; ?>
                >Mục lớn - 0</option>
                <?php  
                ...
                <option value="<?php echo $item['id'] ;?>"
                  <?php if (isset($_POST['parent_id']) && $_POST['parent_id'] == $item['id']) echo 'selected = "selected" ' ; ?>
                >
