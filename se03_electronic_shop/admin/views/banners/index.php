  ...
  <div class="">
    <div class="page-title">
      <div class="title_left" style="clear: both;">
        <h3>Danh sách thương hiệu</small></h3>
    </div>

    <div class="title_right" style="float: right;">
        <div class="add-banner" style="font-size: 14px;border-radius: 10px;padding: 10px;float: right;">
        <a href="index.php?c=banner&m=create" style="color: #BA5905;">THÊM MỚI</a>
    </div>
</div>
</div>
        ...
        if (count($banners) > 0) : 
            ...
            foreach ($banners as $item) :
                ...
                <tr>
                    ...
                    <td>
                        <a href="index.php?c=banner&m=update&id=<?php echo $item['id'];?>" title="">Sửa</a>
                    </td>
                    <td>
                        <a onclick="return checkDelete();" href="index.php?c=banner&m=delete&id=<?php echo $item['id'];?>" title="">Xóa</a>
                    </td>
